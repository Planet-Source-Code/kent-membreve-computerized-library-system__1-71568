...
Begin VB.Form Form4 
   ...
   Begin VB.TextBox Text3 
      ...
      TabIndex        =   22
      Text            =   "0"
      ToolTipText     =   "if the barrower type is instructor this  will display a number equal to 5 months"
      Top             =   3480
      Width           =   2055
   End
...
Else
    ...
    Text6.Text = (Form1.Adodc1.Recordset.Fields(3))
...
If Text6.Text = "Instructor" Then
Label18.Caption = "Instructor"
Text3.Text = 150
Else
Text3.Text = "0"
Label18.Caption = "Student"
End If
End Sub
